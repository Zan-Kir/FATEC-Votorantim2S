...
insert into Cidade
values
('Votorantim', 'SP'), ('Sorocaba','SP'), ('Itu','SP'),
('São Roque','SP'), ('Rio de Janeiro', 'RJ')

insert into Empregado
values
('Sarah Martins', '05-04-2019', 1500.00), ('Camila Ferreira','07-10-2019',2000.00),
('Vitor Gomes','15-04-2022',3000.00), ('Tiago Cavalcanti','06-12-2021',4000.00),
('Felipe Dias','03-03-2023',10000.00);

select distinct cdestado from Cidade /*mostra somente valores distintos*/
select distinct unidade from produto
select cdestado, nomecidade from Cidade

select 'Código do Cliente', cod_cliente, 'Nome do Cliente', nome_cliente from cliente /*mostrar com nome antes*/
select cod_cliente as 'Código do Cliente', nome_cliente as 'Nome do Cliente' from cliente /*mostrar com outro nome*/
select nome, salario, salario+300 aumento_salario from Empregado /*mostra valor modificado*/
select 'Funcionario: '+nome+' Salário: ' + CONVERT(VARCHAR, salario) as 'Fusão', salario, nome from Empregado /*concatena e mostra como texto*/
select num_pedido, cod_produto, quantidade from item_pedido where quantidade = 45
/* select nrmatricula, primeiro_nome, ultimo_nome, cod_setor from funcionario where cod_setor = 2 */
